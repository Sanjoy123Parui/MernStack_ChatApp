...
contactRouter.route('/update/user/:contact_id').put(userCheckAuth, updateContact);


// delete contact router end-point with delete
contactRouter.route('/remove/user/:contact_id').delete(userCheckAuth, deleteContact);

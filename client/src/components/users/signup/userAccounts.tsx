...
const UserAccounts: React.FC = () => {
    ...
    // here declare modal of context
    const { showUserAccountRemoveModal }: any = useRemoveAccountModal();

    return (
        <>
            <a onClick={showUserAccountRemoveModal} className="flex items-center bg-none hover:bg-slate-200 
            rounded space-x-4 rtl:space-x-reverse">

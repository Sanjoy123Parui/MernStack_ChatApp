                                ...
                                <div className="p-8 lg:p-4 mb-0 lg:mb-12 w-full lg:w-1/2 flex flex-col items-start">
                                    <div className="w-full max-w-[30rem] mx-auto">
                                        ...
                                        <div className="flex items-center justify-center p-1">
                                            <p className="text-base">Please click here to <Link to="/" className="text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">Login</Link> </p>
                                        </div>
                                        {/* end div */}

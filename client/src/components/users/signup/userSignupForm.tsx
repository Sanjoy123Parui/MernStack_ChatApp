    ...
    return (
        <>
            ...
            <div className="flex gap-3 flex-col md:mx-11 mb-8">
                <div className="bg-white border-[2px] rounded-2xl shadow-lg md:p-8 mx-2 md:mx-0 mt-8 p-6">
                    ...
                    <section className="text-gray-600 body-font overflow-hidden">
                        <div className="container px-5 py-7 mx-auto">
                            <div className="grid gap-4 md:grid-cols-2 md:gap-8">
                                ...
                                <div className="lg:flex sm:flex flex-col items-center gap-4 rounded-lg hidden md:block  px-8 py-6 my-8 md:gap-6">

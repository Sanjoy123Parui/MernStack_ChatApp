        ...
        >
          {accountDropdownList.map((subItem: any, j: any) => (
            <li key={j} className="p-[5px] md:p-0 md:text-left">
              <NavLink
                to={subItem.itemPath}
                className="block px-4 mt-3 text-sm md:text-base text-gray-700 hover:text-black"
              >
                {subItem.listItem}
              </NavLink>
            </li>
    ...
    <>
      ...
      >
        ...
        {signupList.map((items: any, i: any) => {
          return (
            ...
            >
              <NavLink
                to={items.itemPath}
                className="block text-gray-600 lg:text-white lg:text-base hover:text-black 
                lg:hover:text-gray-300 transition-colors"
              >
                {items.listItem}
              </NavLink>
            </li>
        ...
        >
          {/*  button of drop-down */}
          <a
            className="flex items-center text-gray-600 lg:text-white hover:text-black 
          lg:hover:text-gray-300 transition-colors"
          >
            Account

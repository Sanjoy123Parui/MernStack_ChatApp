...
// defining SenderImages functional component
const SenderImages: React.FC<senderChatdropDownMenuItems> = ({
  senderchatMenu,
}) => {
  ...
  const { senderImagesMenu, showSenderImagesMenu, hideSenderImagesMenu }: any =
    useSenderMenu();
...
// exporting SenderImages component
export default SenderImages;

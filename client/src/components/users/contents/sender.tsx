...
//   return (
//     <>
//       <div className="bg-indigo-500 text-white p-2 border shadow-md rounded-lg max-w-60 md:max-w-96">
...
//         {/* start text message dilivery time */}
//         <div className="flex items-center justify-end space-x-2 rtl:space-x-reverse">
//           <span className="text-xs font-medium">11:46 PM</span>
...
const SenderVoiceMessage: React.FC = () => {
  return (
    <>
      <div className="bg-indigo-500 text-white p-2 border shadow-md rounded-lg max-w-60 lg:max-w-96">

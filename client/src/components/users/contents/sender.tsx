...
//                 <p className="text-sm text-indigo-100  line-clamp-1">{desc}</p>
//               </div>
//             </div>
//             {/* url content */}
//             <a
...
/* SenderAddToContacts component */
// const SenderAddToContacts: React.FC<any> = ({ senderdropDownMenu }) => {
//   const [senderContactMenu, setSenderContactMenu] = useState<boolean>(false);
...
//   const handleSenderContactMenu = (): any =>
//     setSenderContactMenu((prev: any) => !prev);
//   return (
//     <>
//       <div className="flex items-start gap-2.5">
//         <div className="w-10 h-10 overflow-hidden border-white border-[2px] font-bold bg-gray-100 rounded-full dark:bg-gray-700">
...
//             <button
//               type="button"
//               onClick={handleSenderContactMenu}
//               className="p-1 rounded-full hover:bg-indigo-600"
//             >
//               <BsThreeDotsVertical className="w-5 h-5" />
//             </button>
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-end justify-end gap-y-2">
        ...
        {/* <SenderAddToContacts senderdropDownMenu={senderdropDownMenu} /> */}
      </div>
      {/* end div */}
    </>
  );

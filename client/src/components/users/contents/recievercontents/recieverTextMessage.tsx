...
// defining RecieverTextMessage functional component
const RecieverTextMessage: React.FC<recieverChatdropDownMenuItems> = ({
  recieverchatMenu,
}) => {
  const messages: string = `Hi`;

  // declare custom hooks for manage this component state variables
  const { recieverTextMenu, showRecieverTextMenu, hideRecieverTextMenu }: any =
    useRecieverMenu();
...
// exporting RecieverTextMessage component
export default RecieverTextMessage;

...
// defining RecieverImages functional component
const RecieverImages: React.FC<recieverChatdropDownMenuItems> = ({
  recieverchatMenu,
}) => {
        ...
        rounded-lg max-w-xs sm:max-w-sm md:max-w-md"
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={showRecieverImagesMenu}
                  ...
                  {recieverchatMenu.map((item: any, index: any) => (
                    <li key={index}>
                      <a
                        ...
                        onClick={hideRecieverImagesMenu}
                      >
                        {item}
                      </a>
                    </li>
...
// exporting RecieverImages component
export default RecieverImages;

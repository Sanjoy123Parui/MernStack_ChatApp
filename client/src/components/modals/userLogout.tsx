...
const UserLogout: React.FC = () => {
    ...
    const { userLogoutAlertMessage, closeLogoutModal }: any = useUserLogoutModalContext();
        ...
        <>
            ...
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                <div className="relative bg-white rounded-lg shadow-lg p-6 mb-12 md:mb-96 lg:mb-80 w-11/12 sm:w-96 max-w-lg">
                    ...
                    <button type="button" onClick={closeLogoutModal} className="absolute top-3 right-3 text-gray-400 bg-transparent 
                    hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 flex justify-center 
                    items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="popup-modal">
                        <IoMdClose />
                    </button>
                    ...
                    <div className="p-4 md:p-5 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center sm:justify-end px-6 space-y-4 sm:space-y-0 sm:space-x-4">
                            <button type="button" className="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 w-full sm:w-auto">
                                Yes, I'am sure
                            </button>

                            <button type="button" onClick={closeLogoutModal} className="px-4 py-2 bg-green-500 text-white rounded 
                            hover:bg-green-600 w-full sm:w-auto">
                                No, cancel
                            </button>
                        </div>
                    </div>
